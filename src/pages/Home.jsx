    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden z-0">
          ...
          >
            <source 
              src="https://assets.mixkit.co/videos/preview/mixkit-top-view-of-various-fast-food-on-a-table-10468-large.mp4" 
              type="video/mp4" 
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-6 italic">
                "The food is always fresh and delicious! Delivery is surprisingly fast and the app is so easy to use. My go-to food delivery service!"
              </p>
            ...
            >
              ...
              <p className="text-gray-600 mb-6 italic">
                "I love the variety of restaurants available. The food always arrives hot and the delivery people are so friendly. 10/10 recommend!"
              </p>
              <div className="flex items-center">
                <img 
            ...
            >
              ...
              <p className="text-gray-600 mb-6 italic">
                "The special dietary options are amazing! As someone with allergies, I appreciate how careful they are with my orders. Great service!"
              </p>
              <div className="flex items-center">
                <img 
